...
!function(n){"function"==typeof define&&define.amd?define(["jquery"],(function(e){return n(e)})):"object"==typeof module&&"object"==typeof module.exports?module.exports=n(require("jquery")):n(jQuery)}((function(n){void 0!==n.easing&&(n.easing.jswing=n.easing.swing);var e=Math.pow,t=Math.sqrt,u=Math.sin,r=Math.cos,i=Math.PI,a=1.70158,o=1.525*a,c=a+1,s=2*i/3,f=2*i/4.5;function I(n){var e=7.5625,t=2.75;return n<1/t?e*n*n:n<2/t?e*(n-=1.5/t)*n+.75:n<2.5/t?e*(n-=2.25/t)*n+.9375:e*(n-=2.625/t)*n+.984375}return n.extend(n.easing,{def:"easeOutQuad",swing:function(e){return n.easing[n.easing.def](e)},easeInQuad:function(n){return n*n},easeOutQuad:function(n){return 1-(1-n)*(1-n)},easeInOutQuad:function(n){return n<.5?2*n*n:1-e(-2*n+2,2)/2},easeInCubic:function(n){return n*n*n},easeOutCubic:function(n){return 1-e(1-n,3)},easeInOutCubic:function(n){return n<.5?4*n*n*n:1-e(-2*n+2,3)/2},easeInQuart:function(n){return n*n*n*n},easeOutQuart:function(n){return 1-e(1-n,4)},easeInOutQuart:function(n){return n<.5?8*n*n*n*n:1-e(-2*n+2,4)/2},easeInQuint:function(n){return n*n*n*n*n},easeOutQuint:function(n){return 1-e(1-n,5)},easeInOutQuint:function(n){return n<.5?16*n*n*n*n*n:1-e(-2*n+2,5)/2},easeInSine:function(n){return 1-r(n*i/2)},easeOutSine:function(n){return u(n*i/2)},easeInOutSine:function(n){return-(r(i*n)-1)/2},easeInExpo:function(n){return 0===n?0:e(2,10*n-10)},easeOutExpo:function(n){return 1===n?1:1-e(2,-10*n)},easeInOutExpo:function(n){return 0===n?0:1===n?1:n<.5?e(2,20*n-10)/2:(2-e(2,-20*n+10))/2},easeInCirc:function(n){return 1-t(1-e(n,2))},easeOutCirc:function(n){return t(1-e(n-1,2))},easeInOutCirc:function(n){return n<.5?(1-t(1-e(2*n,2)))/2:(t(1-e(-2*n+2,2))+1)/2},easeInElastic:function(n){return 0===n?0:1===n?1:-e(2,10*n-10)*u((10*n-10.75)*s)},easeOutElastic:function(n){return 0===n?0:1===n?1:e(2,-10*n)*u((10*n-.75)*s)+1},easeInOutElastic:function(n){return 0===n?0:1===n?1:n<.5?-e(2,20*n-10)*u((20*n-11.125)*f)/2:e(2,-20*n+10)*u((20*n-11.125)*f)/2+1},easeInBack:function(n){return c*n*n*n-a*n*n},easeOutBack:function(n){return 1+c*e(n-1,3)+a*e(n-1,2)},easeInOutBack:function(n){return n<.5?e(2*n,2)*(7.189819*n-o)/2:(e(2*n-2,2)*((o+1)*(2*n-2)+o)+2)/2},easeInBounce:function(n){return 1-I(1-n)},easeOutBounce:I,easeInOutBounce:function(n){return n<.5?(1-I(1-2*n))/2:(1+I(2*n-1))/2}}),n}));
let currentStep=0;const steps=document.querySelectorAll(".step"),contents=document.querySelectorAll(".content");function updateStepper(){steps.forEach(((e,t)=>{e.classList.toggle("active",t<=currentStep)})),contents.forEach(((e,t)=>{e.classList.toggle("active",t===currentStep)}))}function nextStep(){currentStep<steps.length-1&&(currentStep++,updateStepper())}function prevStep(){currentStep>0&&(currentStep--,updateStepper())}$(".multiple-items").slick({infinite:!0,slidesToShow:3,slidesToScroll:3}),$(document).ready((function(){$(window).on("scroll",(function(){$(window).scrollTop()>50?$(".inner-navbar").addClass("active"):$(".inner-navbar").removeClass("active")}));const e=document.querySelectorAll("section[id]");window.addEventListener("scroll",(function(){let t=window.pageYOffset;e.forEach((e=>{const c=e.offsetHeight,n=e.offsetTop-550;sectionId=e.getAttribute("id"),t>n&&t<=n+c?document.querySelector(".navigation .nav-content .link-part .bottom-links a[href*="+sectionId+"]").classList.add("active"):document.querySelector(".navigation .nav-content .link-part .bottom-links a[href*="+sectionId+"]").classList.remove("active")}))}));const t=document.querySelector(".slide-page"),c=document.querySelector(".firstNext"),n=document.querySelector(".prev-1"),s=document.querySelector(".next-1"),i=document.querySelector(".prev-2"),r=document.querySelector(".next-2"),a=document.querySelector(".next-3"),o=document.querySelector(".prev-3"),l=document.querySelector(".prev-4"),d=document.querySelector(".submit"),u=document.querySelectorAll(".step p"),v=document.querySelectorAll(".step");let f=1;c.addEventListener("click",(function(e){e.preventDefault(),t.style.marginLeft="-25%",v[f-1].classList.add("active"),u[f-1].classList.add("active"),f+=1})),s.addEventListener("click",(function(e){e.preventDefault(),t.style.marginLeft="-50%",v[f-1].classList.add("active"),u[f-1].classList.add("active"),f+=1})),r.addEventListener("click",(function(e){e.preventDefault(),t.style.marginLeft="-75%",v[f-1].classList.add("active"),u[f-1].classList.add("active"),f+=1})),a.addEventListener("click",(function(e){e.preventDefault(),t.style.marginLeft="-100%",v[f-1].classList.add("active"),u[f-1].classList.add("active"),f+=1})),d.addEventListener("click",(function(){v[f-1].classList.add("active"),u[f-1].classList.add("active"),f+=1,setTimeout((function(){alert("Your Form Successfully Signed up"),location.reload()}),800)})),n.addEventListener("click",(function(e){e.preventDefault(),t.style.marginLeft="0%",v[f-2].classList.remove("active"),u[f-2].classList.remove("active"),f-=1})),i.addEventListener("click",(function(e){e.preventDefault(),t.style.marginLeft="-25%",v[f-2].classList.remove("active"),u[f-2].classList.remove("active"),f-=1})),o.addEventListener("click",(function(e){e.preventDefault(),t.style.marginLeft="-50%",v[f-2].classList.remove("active"),u[f-2].classList.remove("active"),f-=1})),l.addEventListener("click",(function(e){e.preventDefault(),t.style.marginLeft="-50%",v[f-2].classList.remove("active"),u[f-2].classList.remove("active"),f-=1}))}));