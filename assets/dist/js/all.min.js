...
$(document).ready((function(){const t=document.querySelectorAll("section[id]");window.addEventListener("scroll",(function(){let e=window.pageYOffset;t.forEach((t=>{const n=t.offsetHeight,o=t.offsetTop-550;sectionId=t.getAttribute("id"),e>o&&e<=o+n?document.querySelector(".navigation .nav-content .link-part .bottom-links a[href*="+sectionId+"]").classList.add("active"):document.querySelector(".navigation .nav-content .link-part .bottom-links a[href*="+sectionId+"]").classList.remove("active")}))}))}));