...
let currentStep=0;const steps=document.querySelectorAll(".step"),contents=document.querySelectorAll(".content");function updateStepper(){steps.forEach(((e,t)=>{e.classList.toggle("active",t<=currentStep)})),contents.forEach(((e,t)=>{e.classList.toggle("active",t===currentStep)}))}function nextStep(){currentStep<steps.length-1&&(currentStep++,updateStepper())}function prevStep(){currentStep>0&&(currentStep--,updateStepper())}$(".pricing-slide").slick({dots:!0,infinite:!1,speed:300,slidesToShow:2,slidesToScroll:2,responsive:[{breakpoint:1024,settings:{slidesToShow:2,slidesToScroll:2,infinite:!0,dots:!0}},{breakpoint:600,settings:{slidesToShow:2,slidesToScroll:2}},{breakpoint:480,settings:{slidesToShow:1,slidesToScroll:1}}]}),$(document).ready((function(){$(window).on("scroll",(function(){$(window).scrollTop()>50?$(".inner-navbar").addClass("active"):$(".inner-navbar").removeClass("active")})),$(".add-after2").after('<svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M8.33366 2.5L3.75033 7.08333L1.66699 5" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>'),$(".form-check .add-after").after('<svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M8.33366 2.5L3.75033 7.08333L1.66699 5" stroke="white" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>'),$(".form-check.style-2 .add-after").after('<svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M8.33366 2.5L3.75033 7.08333L1.66699 5" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>'),$(".btn-number").click((function(e){e.preventDefault(),fieldName=$(this).attr("data-field"),type=$(this).attr("data-type");var t=$("input[name='"+fieldName+"']"),n=parseInt(t.val());isNaN(n)?t.val(0):"minus"==type?(n>t.attr("min")&&t.val(n-1).change(),parseInt(t.val())==t.attr("min")&&$(this).attr("disabled",!0)):"plus"==type&&(n<t.attr("max")&&t.val(n+1).change(),parseInt(t.val())==t.attr("max")&&$(this).attr("disabled",!0))})),$(".input-number").focusin((function(){$(this).data("oldValue",$(this).val())})),$(".input-number").change((function(){minValue=parseInt($(this).attr("min")),maxValue=parseInt($(this).attr("max")),valueCurrent=parseInt($(this).val()),name=$(this).attr("name"),valueCurrent>=minValue?$(".btn-number[data-type='minus'][data-field='"+name+"']").removeAttr("disabled"):(alert("Sorry, the minimum value was reached"),$(this).val($(this).data("oldValue"))),valueCurrent<=maxValue?$(".btn-number[data-type='plus'][data-field='"+name+"']").removeAttr("disabled"):(alert("Sorry, the maximum value was reached"),$(this).val($(this).data("oldValue")))})),$(".input-number").keydown((function(e){-1!==$.inArray(e.keyCode,[46,8,9,27,13,190])||65==e.keyCode&&!0===e.ctrlKey||e.keyCode>=35&&e.keyCode<=39||(e.shiftKey||e.keyCode<48||e.keyCode>57)&&(e.keyCode<96||e.keyCode>105)&&e.preventDefault()}));const e=document.querySelectorAll("section[id]");window.addEventListener("scroll",(function(){let t=window.pageYOffset;e.forEach((e=>{const n=e.offsetHeight,a=e.offsetTop-550;sectionId=e.getAttribute("id"),t>a&&t<=a+n?document.querySelector(".navigation .nav-content .link-part .bottom-links a[href*="+sectionId+"]").classList.add("active"):document.querySelector(".navigation .nav-content .link-part .bottom-links a[href*="+sectionId+"]").classList.remove("active")}))}));const t=document.querySelector(".slide-page"),n=document.querySelector(".firstNext"),a=document.querySelector(".prev-1"),i=document.querySelector(".next-1"),s=document.querySelector(".prev-2"),r=document.querySelector(".next-2"),c=document.querySelector(".next-3"),l=document.querySelector(".prev-3"),o=document.querySelector(".prev-4"),d=document.querySelector(".submit"),u=document.querySelectorAll(".step p"),v=document.querySelectorAll(".step");let p=1;n&&n.addEventListener("click",(function(e){e.preventDefault(),t.style.marginLeft="-20%",v[p-1].classList.add("active"),u[p-1].classList.add("active"),p+=1})),i&&i.addEventListener("click",(function(e){e.preventDefault(),t.style.marginLeft="-50%",v[p-1].classList.add("active"),u[p-1].classList.add("active"),p+=1})),r&&r.addEventListener("click",(function(e){e.preventDefault(),t.style.marginLeft="-75%",v[p-1].classList.add("active"),u[p-1].classList.add("active"),p+=1})),c&&c.addEventListener("click",(function(e){e.preventDefault(),t.style.marginLeft="-100%",v[p-1].classList.add("active"),u[p-1].classList.add("active"),p+=1})),nextBtnFifth&&nextBtnFifth.addEventListener("click",(function(e){e.preventDefault(),t.style.marginLeft="-125%",v[p-1].classList.add("active"),u[p-1].classList.add("active"),p+=1})),d&&d.addEventListener("click",(function(){v[p-1].classList.add("active"),u[p-1].classList.add("active"),p+=1,setTimeout((function(){alert("Your Form Successfully Signed up"),location.reload()}),800)})),a&&a.addEventListener("click",(function(e){e.preventDefault(),t.style.marginLeft="0%",v[p-2].classList.remove("active"),u[p-2].classList.remove("active"),p-=1})),s&&s.addEventListener("click",(function(e){e.preventDefault(),t.style.marginLeft="-20%",v[p-2].classList.remove("active"),u[p-2].classList.remove("active"),p-=1})),l&&l.addEventListener("click",(function(e){e.preventDefault(),t.style.marginLeft="-50%",v[p-2].classList.remove("active"),u[p-2].classList.remove("active"),p-=1})),o&&o.addEventListener("click",(function(e){e.preventDefault(),t.style.marginLeft="-75%",v[p-2].classList.remove("active"),u[p-2].classList.remove("active"),p-=1})),prevBtnSixth&&prevBtnSixth.addEventListener("click",(function(e){e.preventDefault(),t.style.marginLeft="-75%",v[p-2].classList.remove("active"),u[p-2].classList.remove("active"),p-=1}))}));