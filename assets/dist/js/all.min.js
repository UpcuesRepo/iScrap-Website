...
$(".multiple-items").slick({infinite:!0,slidesToShow:3,slidesToScroll:3}),$(document).ready((function(){$(window).on("scroll",(function(){$(window).scrollTop()>50?$(".inner-navbar").addClass("active"):$(".inner-navbar").removeClass("active")}));const e=document.querySelectorAll("section[id]");window.addEventListener("scroll",(function(){let t=window.pageYOffset;e.forEach((e=>{const c=e.offsetHeight,i=e.offsetTop-550;sectionId=e.getAttribute("id"),t>i&&t<=i+c?document.querySelector(".navigation .nav-content .link-part .bottom-links a[href*="+sectionId+"]").classList.add("active"):document.querySelector(".navigation .nav-content .link-part .bottom-links a[href*="+sectionId+"]").classList.remove("active")}))}));const t=document.querySelector(".slide-page"),c=document.querySelector(".firstNext"),i=document.querySelector(".prev-1"),n=document.querySelector(".next-1"),s=document.querySelector(".prev-2"),a=document.querySelector(".next-2"),l=document.querySelector(".next-3"),o=document.querySelector(".prev-3"),r=document.querySelector(".prev-4"),d=document.querySelector(".submit"),u=document.querySelectorAll(".step p"),v=document.querySelectorAll(".step");let f=1;c.addEventListener("click",(function(e){e.preventDefault(),t.style.marginLeft="-25%",v[f-1].classList.add("active"),u[f-1].classList.add("active"),f+=1})),n.addEventListener("click",(function(e){e.preventDefault(),t.style.marginLeft="-50%",v[f-1].classList.add("active"),u[f-1].classList.add("active"),f+=1})),a.addEventListener("click",(function(e){e.preventDefault(),t.style.marginLeft="-75%",v[f-1].classList.add("active"),u[f-1].classList.add("active"),f+=1})),l.addEventListener("click",(function(e){e.preventDefault(),t.style.marginLeft="-100%",v[f-1].classList.add("active"),u[f-1].classList.add("active"),f+=1})),d.addEventListener("click",(function(){v[f-1].classList.add("active"),u[f-1].classList.add("active"),f+=1,setTimeout((function(){alert("Your Form Successfully Signed up"),location.reload()}),800)})),i.addEventListener("click",(function(e){e.preventDefault(),t.style.marginLeft="0%",v[f-2].classList.remove("active"),u[f-2].classList.remove("active"),f-=1})),s.addEventListener("click",(function(e){e.preventDefault(),t.style.marginLeft="-25%",v[f-2].classList.remove("active"),u[f-2].classList.remove("active"),f-=1})),o.addEventListener("click",(function(e){e.preventDefault(),t.style.marginLeft="-50%",v[f-2].classList.remove("active"),u[f-2].classList.remove("active"),f-=1})),r.addEventListener("click",(function(e){e.preventDefault(),t.style.marginLeft="-50%",v[f-2].classList.remove("active"),u[f-2].classList.remove("active"),f-=1}))}));