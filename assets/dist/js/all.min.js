...
$(document).ready((function(){const t=document.querySelectorAll("section[id]");var e,i,n,o,s,a,c;window.addEventListener("scroll",(function(){let e=window.pageYOffset;t.forEach((t=>{const i=t.offsetHeight,n=t.offsetTop-550;sectionId=t.getAttribute("id"),e>n&&e<=n+i?document.querySelector(".navigation .nav-content .link-part .bottom-links a[href*="+sectionId+"]").classList.add("active"):document.querySelector(".navigation .nav-content .link-part .bottom-links a[href*="+sectionId+"]").classList.remove("active")}))})),$(".next").click((function(){if(c)return!1;c=!0,e=$(this).parent(),i=$(this).parent().next(),$("#progressbar li").eq($("fieldset").index(i)).addClass("active"),i.show(),e.animate({opacity:0},{step:function(t,n){a=1-.2*(1-t),o=50*t+"%",s=1-t,e.css({transform:"scale("+a+")",position:"absolute"}),i.css({left:o,opacity:s})},duration:800,complete:function(){e.hide(),c=!1},easing:"easeInOutBack"})})),$(".previous").click((function(){if(c)return!1;c=!0,e=$(this).parent(),n=$(this).parent().prev(),$("#progressbar li").eq($("fieldset").index(e)).removeClass("active"),n.show(),e.animate({opacity:0},{step:function(t,i){a=.8+.2*(1-t),o=50*(1-t)+"%",s=1-t,e.css({left:o}),n.css({transform:"scale("+a+")",position:"relative",opacity:s})},duration:800,complete:function(){e.hide(),c=!1}})}))}));